...
} from "./chunk-XCIG5JA3.js";
import {
  __export
} from "./chunk-PZPFYWHI.js";
import {
  secp256k1,
  sha256
} from "./chunk-DINFMNR7.js";
import {
  BaseError,
  ...
  toBytes,
  toHex
} from "./chunk-NRPGO5WW.js";
import {
  utf8ToBytes
} from "./chunk-C4TDMKNG.js";
...
function accountActions(client) {
  return {
    fundAccount: async ({ address, amount }) => {
      var _a;
      if (((_a = client.chain) == null ? void 0 : _a.id) !== localnet.id) {
    ...
    getCurrentNonce: async ({
      ...
      var _a;
      const addressToUse = address || ((_a = client.account) == null ? void 0 : _a.address);
      if (!addressToUse) {
...
var contractActions = (client, publicClient) => {
  return {
    ...
    readContract: async (args) => {
      ...
      const senderAddress = (account == null ? void 0 : account.address) ?? ((_a = client.account) == null ? void 0 : _a.address) ?? zeroAddress;
      const requestParams = {
        type: "read",
        to: address,
        from: senderAddress,
    ...
    getMinAppealBond: async (args) => {
      var _a, _b;
      const { txId } = args;
      if (!((_a = client.chain.feeManagerContract) == null ? void 0 : _a.address) || !((_b = client.chain.roundsStorageContract) == null ? void 0 : _b.address)) {
    ...
    getRoundNumber: async (args) => {
      var _a;
      if (!((_a = client.chain.roundsStorageContract) == null ? void 0 : _a.address)) {
    ...
    canAppeal: async (args) => {
      var _a;
      if (!((_a = client.chain.appealsContract) == null ? void 0 : _a.address)) {
    ...
    appealTransaction: async (args) => {
      ...
      if (!((_c = client.chain.consensusMainContract) == null ? void 0 : _c.address)) {
...
var getAddTransactionInputCount = (abi) => {
  ...
  return Array.isArray(addTransactionFunction == null ? void 0 : addTransactionFunction.inputs) ? addTransactionFunction.inputs.length : 0;
};
var _encodeAddTransactionData = ({
  ...
  if (getAddTransactionInputCount((_a = client.chain.consensusMainContract) == null ? void 0 : _a.abi) >= 6) {
    return {
...
var _encodeSubmitAppealData = ({
  ...
  return encodeFunctionData({
    abi: (_a = client.chain.consensusMainContract) == null ? void 0 : _a.abi,
...
var isAddTransactionAbiMismatchError = (error) => {
  ...
  const errorMessage = [
    errorObject == null ? void 0 : errorObject.shortMessage,
    errorObject == null ? void 0 : errorObject.details,
    errorObject == null ? void 0 : errorObject.message,
    serializedError,
    String(error ?? "")
...
var _sendTransaction = async ({
  ...
  var _a;
  if (!((_a = client.chain.consensusMainContract) == null ? void 0 : _a.address)) {
  ...
  const sendWithEncodedData = async (encodedDataForSend) => {
    ...
    try {
      estimatedGas = await client.estimateTransactionGas({
        ...
        to: (_a2 = client.chain.consensusMainContract) == null ? void 0 : _a2.address,
    ...
    if ((validatedSenderAccount == null ? void 0 : validatedSenderAccount.type) === "local") {
      if (!(validatedSenderAccount == null ? void 0 : validatedSenderAccount.signTransaction)) {
      ...
      const transactionRequest = {
        ...
        to: (_b = client.chain.consensusMainContract) == null ? void 0 : _b.address,
        data: encodedDataForSend,
        type: "legacy",
        nonce: Number(nonce),
        value,
      ...
      if (receipt.status === "reverted") {
        throw new Error(`Transaction reverted: EVM tx ${txHash} to consensus contract ${(_c = client.chain.consensusMainContract) == null ? void 0 : _c.address} was reverted.`);
      }
    ...
    const formattedRequest = {
      from: validatedSenderAccount.address,
      to: (_d = client.chain.consensusMainContract) == null ? void 0 : _d.address,
      data: encodedDataForSend,
    ...
    if (externalReceipt.status === "reverted") {
      throw new Error(`Transaction reverted: EVM tx ${evmTxHash} to consensus contract ${(_e = client.chain.consensusMainContract) == null ? void 0 : _e.address} was reverted.`);
    }
...
var decodeTransaction = (tx) => {
  ...
  const decodedTx = {
    ...
    numOfInitialValidators: (numOfInitialValidators == null ? void 0 : numOfInitialValidators.toString()) ?? "0",
    ...
    readStateBlockRange: {
      ...
      activationBlock: ((_b = (_a = tx.readStateBlockRange) == null ? void 0 : _a.activationBlock) == null ? void 0 : _b.toString()) ?? "0",
      processingBlock: ((_d = (_c = tx.readStateBlockRange) == null ? void 0 : _c.processingBlock) == null ? void 0 : _d.toString()) ?? "0",
      proposalBlock: ((_f = (_e = tx.readStateBlockRange) == null ? void 0 : _e.proposalBlock) == null ? void 0 : _f.toString()) ?? "0"
    },
    ...
    lastRound: {
      ...tx.lastRound,
      round: ((_h = (_g = tx.lastRound) == null ? void 0 : _g.round) == null ? void 0 : _h.toString()) ?? "0",
      leaderIndex: ((_j = (_i = tx.lastRound) == null ? void 0 : _i.leaderIndex) == null ? void 0 : _j.toString()) ?? "0",
      votesCommitted: ((_l = (_k = tx.lastRound) == null ? void 0 : _k.votesCommitted) == null ? void 0 : _l.toString()) ?? "0",
      votesRevealed: ((_n = (_m = tx.lastRound) == null ? void 0 : _m.votesRevealed) == null ? void 0 : _n.toString()) ?? "0",
      appealBond: ((_p = (_o = tx.lastRound) == null ? void 0 : _o.appealBond) == null ? void 0 : _p.toString()) ?? "0",
      rotationsLeft: ((_r = (_q = tx.lastRound) == null ? void 0 : _q.rotationsLeft) == null ? void 0 : _r.toString()) ?? "0",
      validatorVotesName: (((_s = tx.lastRound) == null ? void 0 : _s.validatorVotes) ?? []).map(
...
var decodeLocalnetTransaction = (tx) => {
  ...
  try {
    const leaderReceipt = (_a = tx.consensus_data) == null ? void 0 : _a.leader_receipt;
    if (leaderReceipt) {
    ...
    if (((_b = tx.data) == null ? void 0 : _b.calldata) && typeof tx.data.calldata === "string") {
      tx.data.calldata = {
...
var transactionActions = (client, publicClient) => ({
  ...
  getTransaction: async ({ hash }) => {
    ...
    const contractAddress = (_a = client.chain.consensusDataContract) == null ? void 0 : _a.address;
    const contractAbi = (_b = client.chain.consensusDataContract) == null ? void 0 : _b.abi;
  ...
  getTriggeredTransactionIds: async ({ hash }) => {
    ...
    const proposalBlock = BigInt(((_a = tx.readStateBlockRange) == null ? void 0 : _a.proposalBlock) ?? "0");
    ...
    const consensusAddress = (_b = client.chain.consensusMainContract) == null ? void 0 : _b.address;
  ...
  getTransactionQueuePosition: async ({ hash }) => {
    var _a, _b;
    const consensusAddress = (_a = client.chain.consensusMainContract) == null ? void 0 : _a.address;
    const consensusAbi = (_b = client.chain.consensusMainContract) == null ? void 0 : _b.abi;
  ...
  estimateTransactionGas: async (transactionParams) => {
    ...
    const formattedParams = {
      from: transactionParams.from || ((_a = client.account) == null ? void 0 : _a.address),
...
var connect = async (client, network = "studionet", snapSource = "npm") => {
  ...
  const chainParams = {
    ...
    blockExplorerUrls: [(_a = selectedNetwork.blockExplorers) == null ? void 0 : _a.default.url]
  };
...
var metamaskClient = async (snapSource = "npm") => {
  ...
  const isFlask = async () => {
    var _a;
    try {
      const clientVersion = await ((_a = window.ethereum) == null ? void 0 : _a.request({
        method: "web3_clientVersion"
      }));
      return clientVersion == null ? void 0 : clientVersion.includes("flask");
    } catch (error) {
  ...
  const installedSnaps = async () => {
    var _a;
    try {
      return await ((_a = window.ethereum) == null ? void 0 : _a.request({
...
function extractRevertReason(err) {
  ...
  if (err instanceof BaseError) {
    ...
    if (revertError instanceof ContractFunctionRevertedError) {
      if ((_a = revertError.data) == null ? void 0 : _a.errorName) {
...
var stakingActions = (client, publicClient) => {
  const executeWrite = async (options) => {
    ...
    const signTransaction2 = account.signTransaction;
    if (!signTransaction2) {
  ...
  const getStakingAddress = () => {
    ...
    if (!(stakingConfig == null ? void 0 : stakingConfig.address) || stakingConfig.address === "0x0000000000000000000000000000000000000000") {
  ...
  return {
    ...
    validatorClaim: async (options) => {
      if (!(options == null ? void 0 : options.validator) && !client.account) {
        throw new Error("Either provide validator address or initialize client with an account");
      }
      const validatorAddress = (options == null ? void 0 : options.validator) || client.account.address;
      const data = encodeFunctionData({
        abi: STAKING_ABI,
...
var createClient2 = (config = { chain: localnet }) => {
  ...
  const clientWithBasicActions = baseClient.extend(publicActions).extend(walletActions).extend((client) => accountActions(client));
  const clientWithTransactionActions = {
    ...
    ...walletActions2(clientWithBasicActions)
  };
...
var createPublicClient2 = (chainConfig, customTransport) => {
  return createPublicClient({ chain: chainConfig, transport: customTransport });
};
var generatePrivateKey2 = () => generatePrivateKey();
var createAccount = (accountPrivateKey) => {
  const privateKey = accountPrivateKey || generatePrivateKey2();
...
*/
//# sourceMappingURL=genlayer-js.js.map
